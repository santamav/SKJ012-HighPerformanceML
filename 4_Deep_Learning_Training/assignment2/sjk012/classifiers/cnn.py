...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        affine_out, affine_cache = fc_relu_forward(conv_out, W2, b2)
        scores, scores_cache = fc_forward(affine_out, W3, b3)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        daffine_out, dW3, db3 = fc_backward(dscores, scores_cache)
        dconv_out, dW2, db2 = fc_relu_backward(daffine_out, affine_cache)
